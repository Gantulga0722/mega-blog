...
export const Footer = () => {
  return (
    <div className="flex h-[495px] p-[64px_352px_0_352px] flex-col items-start gap-[25px] shrink-0 border-t border-[#E8E8EA] bg-[#F6F6F7] mx-auto">
      ...
      <div className="flex w-[1216px] h-[95px] p-[32px_0] items-center gap-16 shrink-0 border-t border-[#DCDDDF]">
