...
export const Highlight = () => {
  return (
    <div className="flex flex-col gap-[11px]">
      {highlightData.map((highL) => (
        <div className="w-[1216px] h-[600px] shrink-0 rounded-[12px] bg-[url(/images/highlight-img.jpg)] bg-cover bg-no-repeat relative">
